...
(function ($) {
    ...
    $.extend($.jqx._jqxComboBox.prototype, {
        ...
        render: function () {
            ...
            that.dropdownlistContent.append($('<input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="box-sizing: border-box; margin: 0; padding: 0; padding-left: 1rem; padding-right: 1rem border: 0;" type="textarea"/>'));
